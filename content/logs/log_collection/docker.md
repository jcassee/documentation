...
[1]: https://docs.datadoghq.com/logs/log_collection/#multi-line-aggregation
{{% /tab %}}
{{% tab "Kubernetes" %}}
...
[1]: https://docs.datadoghq.com/agent/autodiscovery/?tab=kubernetes#setting-up-check-templates
{{% /tab %}}
{{< /tabs >}}
...
[2]: https://docs.datadoghq.com/agent/autodiscovery/?tab=kubernetes#setting-up-check-templates
