...
Once SAML is configured in Datadog and your IdP is set up to accept requests from Datadog, users can log in by using the Single Sign On URL that is shown in the Status box at the top of the [SAML Configuration page][5].
{{< img src="account_management/saml/saml_enabled.png" alt="Saml Enabled" responsive="true" >}}

The Single Sign On URL is also displayed on the [Team page][6].
...
The following features can be enabled through the [SAML Configuration dialog][5].
...
Some organizations might not want to invite all of their users to Datadog. If you would like to make changes to how SAML works for your account, [contact support][12].
...
[7]: /account_management/faq/how-do-i-configure-google-as-a-saml-idp
[8]: /account_management/faq/how-do-i-configure-azure-ad-as-a-saml-idp
[9]: /account_management/faq/how-do-i-setup-microsoft-active-directory-federation-services-as-a-saml-idp
[10]: /account_management/faq/how-do-i-configure-nopassword-as-a-saml-idp
[11]: /account_management/faq/how-do-i-configure-okta-as-a-saml-idp
[12]: /help
